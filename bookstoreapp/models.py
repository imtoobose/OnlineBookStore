...
class ContactForm(models.Model):
    surname = models.CharField(default='Anonymous', max_length=1000, blank=True, null=True)
    name = models.CharField(default='Anonymous', max_length=1000, blank=True, null=True)
    city = models.CharField(default='Anonymous', max_length=1000, blank=True, null=True)
    email = models.CharField(default='Anonymous', max_length=1000, blank=True, null=True)
    Company = models.CharField(default='Anonymous', max_length=1000, blank=True, null=True)
    CompanyAddress = models.CharField(default='Anonymous', max_length=1000, blank=True, null=True)
    Postcode = models.CharField(default='Anonymous', max_length=1000, blank=True, null=True)
    Message = models.CharField(default='Anonymous', max_length=10000, blank=True, null=True)
    subject = models.CharField(default='Anonymous', max_length=1000, blank=True, null=True)
    Phone = models.CharField(default='Anonymous', max_length=1000, blank=True, null=True)
    function = models.CharField(default='Anonymous', max_length=1000, blank=True, null=True)
